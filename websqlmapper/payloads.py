...
ERROR_SIGNATURES = {
    "mysql": ["you have an error in your sql syntax", "mysql_fetch", "mysqli", "sqlstate[42000]"],
    "postgresql": ["postgresql", "pg_query", "unterminated quoted string", "syntax error at or near"],
    "sqlite": ["sqlite error", "sqlite3.operationalerror", "unrecognized token", "near \"", "sqlite"],
    "mssql": ["sql server", "microsoft ole db provider", "unclosed quotation mark", "odbc sql server driver"],
